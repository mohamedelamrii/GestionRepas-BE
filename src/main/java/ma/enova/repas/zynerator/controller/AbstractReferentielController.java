package ma.enova.repas.zynerator.controller;
...
import ma.enova.repas.zynerator.converter.AbstractReferentielConverter;
...
import ma.enova.repas.zynerator.exception.GlobalException;
import ma.enova.repas.zynerator.export.ExportModel;
...
public class AbstractReferentielController<T extends AuditBusinessObjectEnhanced, DTO extends ReferentielBaseDto, H extends HistBusinessObject, Criteria extends BaseCriteria, HistoryCriteria extends BaseCriteria, SERV extends IService<T, DTO, Criteria, HistoryCriteria>, CONV extends AbstractReferentielConverter<T, DTO, H>> {

    protected SERV service;
    protected AbstractReferentielConverter<T, DTO, H> converter;
    @Autowired
