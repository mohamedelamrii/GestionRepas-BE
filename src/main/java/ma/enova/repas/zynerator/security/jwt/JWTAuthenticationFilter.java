package ma.enova.repas.zynerator.security.jwt;
...
import ma.enova.repas.RepasApplication;
import ma.enova.repas.zynerator.security.common.SecurityParams;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = RepasApplication.getCtx().getBean(UserService.class);
