...
@Service
public class PlanningResponsableServiceImpl extends AbstractServiceImpl<Planning, PlanningDto,PlanningHistory, PlanningCriteria, PlanningHistoryCriteria, PlanningDao,
PlanningHistoryDao, PlanningConverter> implements PlanningResponsableService {
    ...
    @Autowired
    private JourResponsableService jourService ;
    @Autowired
    private PlanningRepasResponsableService planningRepasService ;
    public PlanningResponsableServiceImpl(PlanningDao dao, PlanningHistoryDao historyDao, PlanningConverter converter) {
