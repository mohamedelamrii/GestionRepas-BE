...
@Service
public class PlanningRepasAdminServiceImpl extends AbstractServiceImpl<PlanningRepas, PlanningRepasDto,PlanningRepasHistory, PlanningRepasCriteria, PlanningRepasHistoryCriteria, PlanningRepasDao,
PlanningRepasHistoryDao, PlanningRepasConverter> implements PlanningRepasAdminService {
    ...
    @Autowired
    private PlanningAdminService planningService ;
    @Autowired
    private TypeRepasAdminService typeRepasService ;
    @Autowired
    private RepasAdminService repasService ;
    public PlanningRepasAdminServiceImpl(PlanningRepasDao dao, PlanningRepasHistoryDao historyDao, PlanningRepasConverter converter) {
