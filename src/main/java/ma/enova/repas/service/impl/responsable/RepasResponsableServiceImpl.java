...
@Service
public class RepasResponsableServiceImpl extends AbstractServiceImpl<Repas, RepasDto,RepasHistory, RepasCriteria, RepasHistoryCriteria, RepasDao,
RepasHistoryDao, RepasConverter> implements RepasResponsableService {
    ...
    @Autowired
    private RepasCategoriePatientResponsableService repasCategoriePatientService ;
    @Autowired
    private TypeRepasResponsableService typeRepasService ;
    public RepasResponsableServiceImpl(RepasDao dao, RepasHistoryDao historyDao, RepasConverter converter) {
