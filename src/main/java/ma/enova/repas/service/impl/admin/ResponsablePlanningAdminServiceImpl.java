...
import ma.enova.repas.service.facade.admin.ResponsablePlanningAdminService;
...
@Service
public class ResponsablePlanningAdminServiceImpl extends AbstractServiceImpl<ResponsablePlanning, ResponsablePlanningDto,ResponsablePlanningHistory, ResponsablePlanningCriteria, ResponsablePlanningHistoryCriteria, ResponsablePlanningDao,
ResponsablePlanningHistoryDao, ResponsablePlanningConverter> implements ResponsablePlanningAdminService {
    ...
    public ResponsablePlanningAdminServiceImpl(ResponsablePlanningDao dao, ResponsablePlanningHistoryDao historyDao, ResponsablePlanningConverter converter) {
