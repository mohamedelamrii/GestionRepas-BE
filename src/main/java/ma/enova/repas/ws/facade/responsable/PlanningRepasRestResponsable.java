...
@RestController
@RequestMapping("/api/responsable/planningRepas")
public class PlanningRepasRestResponsable  extends AbstractController<PlanningRepas, PlanningRepasDto, PlanningRepasHistory, PlanningRepasCriteria, PlanningRepasHistoryCriteria, PlanningRepasResponsableService, PlanningRepasConverter> {
    ...
    public PlanningRepasRestResponsable (PlanningRepasResponsableService service, PlanningRepasConverter converter) {
