...
import ma.enova.repas.workflow.responsable.process.planning.save.PlanningSaveResponsableProcess ;
import ma.enova.repas.workflow.responsable.process.planning.save.PlanningSaveResponsableInput ;
import ma.enova.repas.workflow.responsable.process.planning.save.PlanningSaveResponsableOutput ;
...
public class PlanningRestResponsable  extends AbstractController<Planning, PlanningDto, PlanningHistory, PlanningCriteria, PlanningHistoryCriteria, PlanningResponsableService, PlanningConverter> {
    ...
    public ResponseEntity<Result<PlanningSaveResponsableInput,PlanningSaveResponsableOutput, Planning>> saveProcess(@RequestBody PlanningSaveResponsableInput input) throws Exception {
        Result<PlanningSaveResponsableInput, PlanningSaveResponsableOutput, Planning> result = planningSaveResponsableProcess.execute(input);
    ...
    public PlanningRestResponsable (PlanningResponsableService service, PlanningConverter converter) {
        super(service, converter);
    }

    @Autowired
    private PlanningSaveResponsableProcess planningSaveResponsableProcess;
