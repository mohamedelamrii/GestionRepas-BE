...
import ma.enova.repas.workflow.responsable.process.planningexecution.save.PlanningExecutionSaveResponsableProcess ;
import ma.enova.repas.workflow.responsable.process.planningexecution.save.PlanningExecutionSaveResponsableInput ;
import ma.enova.repas.workflow.responsable.process.planningexecution.save.PlanningExecutionSaveResponsableOutput ;

@Api("Manages planningExecution services")
@RestController
@RequestMapping("/api/responsable/planningExecution/")
public class PlanningExecutionRestResponsable  extends AbstractController<PlanningExecution, PlanningExecutionDto, PlanningExecutionHistory, PlanningExecutionCriteria, PlanningExecutionHistoryCriteria, PlanningExecutionResponsableService, PlanningExecutionConverter> {

    @ApiOperation("save a planningExecution")
    @PostMapping("process/save")
    public ResponseEntity<Result<PlanningExecutionSaveResponsableInput,PlanningExecutionSaveResponsableOutput, PlanningExecution>> saveProcess(@RequestBody PlanningExecutionSaveResponsableInput input) throws Exception {
        Result<PlanningExecutionSaveResponsableInput, PlanningExecutionSaveResponsableOutput, PlanningExecution> result = planningExecutionSaveResponsableProcess.execute(input);
    ...
    public PlanningExecutionRestResponsable (PlanningExecutionResponsableService service, PlanningExecutionConverter converter) {
        super(service, converter);
    }

    @Autowired
    private PlanningExecutionSaveResponsableProcess planningExecutionSaveResponsableProcess;
