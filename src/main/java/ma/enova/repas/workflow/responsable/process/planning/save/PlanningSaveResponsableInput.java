...
import ma.enova.repas.zynerator.process.AbstractProcessInput;


@JsonInclude(JsonInclude.Include.NON_NULL)
public class PlanningSaveResponsableInput extends AbstractProcessInput {
    ...
    public void setCategoriePatientDto(CategoriePatientDto categoriePatient){
    ...
    public void setJourDto(JourDto jour){
        this.jour = jour;
    }
