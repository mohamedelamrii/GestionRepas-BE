...
@Component
public class PlanningSaveAdminConverter extends AbstractProcessConverter<PlanningSaveAdminInput,PlanningSaveAdminOutput,Planning> {
    ...
    public PlanningSaveAdminConverter(){
        super(Planning.class, PlanningSaveAdminInput.class, PlanningSaveAdminOutput.class);
    }

    @Override
    public Planning toItem(PlanningSaveAdminInput input) {
        if (input == null) {
            return null;
        } else {
    ...
    @Override
    public PlanningSaveAdminOutput toOutput(Planning item) {
        if (item == null) {
            return null;
        } else {
            PlanningSaveAdminOutput output = new PlanningSaveAdminOutput();
